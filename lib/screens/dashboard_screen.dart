...
Future<void> _loadDataFromApi() async {
  ...
  try {
    ...
    // ✅ CEK SESSION EXPIRED
    if (saldoResult['token_expired'] == true || taqsithResult['token_expired'] == true) {
      print('🚨 Session expired detected in dashboard API');
      // Biarkan GlobalSessionChecker yang handle logout
      return;
    }
