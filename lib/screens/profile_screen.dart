...
import '../services/global_session_checker.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  // ✅ SESSION CHECKER UNTUK PROFILE
  void _startSessionChecker() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      globalSessionChecker.startSessionChecker(context);
      print('✅ Global session checker started in Profile');
    });
  }

  @override
  void didChangeAppLifecycleState(AppLifecycleState state) {
    print('📱 Profile App lifecycle state: $state');
    
    if (state == AppLifecycleState.resumed) {
      print('🔄 Profile resumed, starting session checker...');
      _startSessionChecker();
    } else if (state == AppLifecycleState.paused || state == AppLifecycleState.inactive) {
      print('🔄 Profile paused, stopping session checker...');
      globalSessionChecker.stopSessionChecker();
    }
  }
